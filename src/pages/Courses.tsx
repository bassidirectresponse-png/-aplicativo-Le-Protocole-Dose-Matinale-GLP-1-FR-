...
import { courseModules, totalLessons, Lesson } from '../data/courseModules';
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-300 leading-relaxed mt-1">
                Commencez par le Module 1, regardez chaque leçon dans l'ordre, puis appliquez le Shot Matinal une fois les doses comprises.
              </p>
            </div>
          </div>
        </div>
        ...
        {courseModules.map(module => {
          ...
          return (
            <div key={module.id} className="bg-white rounded-3xl border border-pink-100 shadow-sm overflow-hidden">
              ...
              >
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-pink-500 to-rose-500 text-white flex items-center justify-center font-black text-lg flex-shrink-0">
                  {module.number}
                </div>
                ...
                <div className="flex flex-col items-end gap-1 flex-shrink-0">
                  <span className="text-[10px] font-black text-gray-400">{moduleCompleted}/{module.lessons.length}</span>
                  <ChevronRight
                    size={20}
                  ...
                  {module.lessons.map(lesson => {
                    ...
                    return (
                      <button
                        ...
                        className="w-full flex items-center gap-3 p-3 rounded-2xl bg-[#fff7fb] hover:bg-pink-50 transition-colors text-left"
                      >
                        <div
        ...
        >
          <div className="flex items-center gap-3 text-left">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-0.5">Quantités ajustées à votre poids</p>
            </div>
          </div>
